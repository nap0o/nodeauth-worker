const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/qr-utils-DSii33i3.js","assets/element-plus-Dh0klhaa.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh61In7b.css","assets/index-Co_0hqsi.js","assets/pdf-utils-r4RjNe6V.js","assets/compression-utils-CXh1ITwj.js","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-C-OQsQoR.js","assets/index-CLSE-HWx.css"])))=>i.map(i=>d[i]);
import { _ as ne, __tla as __tla_0 } from "./pdf-utils-r4RjNe6V.js";
import { n as pe, O as _e, p as V, b as ee, v as fe, __tla as __tla_1 } from "./vaultService-B5YKm4cj.js";
...
import { l as ue, d as Ue, e as De, __tla as __tla_2 } from "./index-Co_0hqsi.js";
import { a as Re } from "./qr-utils-DSii33i3.js";
import { a as he } from "./argon2-browser-qelKfid9.js";
import { l as be, __tla as __tla_3 } from "./resourceRegistry-COxFgigF.js";
...
`)[0].toLowerCase() : "";
    ...
    const Ve = {
        ...
        async exportToGoogleAuth (n) {
            ...
            const i = Math.floor(Math.random() * 2147483647), l = await ne(()=>import("./qr-utils-DSii33i3.js").then((w)=>w.b), __vite__mapDeps([0,1,2,3])), f = [];
            function g(w, y) {
...
`;
    ...
    const oe = {
        ...
        async exportToHtml (n) {
            const r = await ne(()=>import("./qr-utils-DSii33i3.js").then((t)=>t.b), __vite__mapDeps([0,1,2,3])), e = [];
            e.push(`
      <!DOCTYPE html>
      <html>
      <head>
        ...
        async fetchAllVault () {
            ...
            try {
                const { useAppLockStore: e } = await ne(async ()=>{
                    const { useAppLockStore: l } = await import("./index-Co_0hqsi.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((f)=>f.D);
                    return {
                    ...
                    const { unmaskSecretFront: l } = await import("./index-Co_0hqsi.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((f)=>f.C);
                    return {
