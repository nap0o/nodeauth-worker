...
import { _ as ae, __tla as __tla_0 } from "./pdf-utils-DsJhLm1-.js";
import { p as K, v as ce, b as re, __tla as __tla_1 } from "./vaultService-Arpi8dy-.js";
import { l as D, d as ge, e as ye, __tla as __tla_2 } from "./index-B-heULEF.js";
import { a as le } from "./argon2-browser-CaBKgmPA.js";
import { l as he, __tla as __tla_3 } from "./resourceRegistry-CppKO0Ra.js";
import { argon2id as me } from "./hash-wasm-Dup_VHWH.js";
import { unzipSync as we } from "./compression-utils-CXh1ITwj.js";
import { a as Ae } from "./qr-utils-BhF2IEGi.js";
...
import "./element-plus-B-gPN0Fq.js";
...
`;
        ...
        async exportAsGaMigration (s) {
            ...
            const e = Math.floor(Math.random() * 2147483647), u = await ae(()=>import("./qr-utils-BhF2IEGi.js").then((h)=>h.b), __vite__mapDeps([0,1,2,3])), n = [];
            function a(h, m) {
        ...
        async exportAsHtml (s) {
            const i = await ae(()=>import("./qr-utils-BhF2IEGi.js").then((e)=>e.b), __vite__mapDeps([0,1,2,3])), t = [];
            t.push(`
      <!DOCTYPE html>
      <html>
      <head>
