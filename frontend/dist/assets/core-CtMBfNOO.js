const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web3-vendor-BvADb-UB.js","assets/pdf-utils-DsJhLm1-.js","assets/compression-utils-CXh1ITwj.js","assets/element-plus-B-gPN0Fq.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh61In7b.css","assets/features-DIE-UkRK.js","assets/basic-eNHjB76Z.js","assets/index-QrxbnXuv.js","assets/qr-utils-BhF2IEGi.js","assets/w3m-modal-nmMc1HGj.js"])))=>i.map(i=>d[i]);
import { _ as Ut, __tla as __tla_0 } from "./pdf-utils-DsJhLm1-.js";
import { f as Yn, e as At, G as As, U as Ns, a as Nn, h as Nt, b as bs, t as bn, N as Is, __tla as __tla_1 } from "./web3-vendor-BvADb-UB.js";
    ...
    async function Un() {
        if (!Jt) {
            const { createPublicClient: e, http: t, defineChain: n } = await Ut(async ()=>{
                const { createPublicClient: s, http: r, defineChain: a } = await import("./web3-vendor-BvADb-UB.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.c);
                return {
...
`;
        ...
        async initialize(t) {
            if (this.initializeProjectSettings(t), this.initControllers(t), await this.initChainAdapters(), this.sendInitializeEvent(t), t.features?.headless && !te.hasInjectedConnectors() && A.prefetch({
                ...
                const { ReownAuthentication: n } = await Ut(async ()=>{
                    const { ReownAuthentication: r } = await import("./features-DIE-UkRK.js");
                    return {
    ...
    class ws extends Sa {
        ...
        async injectModalUi() {
            if (!Gn && E.isClient()) {
                if (await Ut(()=>import("./basic-eNHjB76Z.js"), __vite__mapDeps([7,8,1,2,9,3,4,5,0])), await Ut(()=>import("./w3m-modal-nmMc1HGj.js"), __vite__mapDeps([10,8,1,2,0,3,4,5])), !document.querySelector("w3m-modal")) {
