const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web3-vendor-CO8wHL-u.js","assets/pdf-utils-CLgdGVwQ.js","assets/compression-utils-CXh1ITwj.js","assets/element-plus-CVRB8fAt.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh61In7b.css","assets/features-Dg52djqm.js","assets/basic-Cnmx4mU2.js","assets/index-Bk8h7Yfs.js","assets/qr-utils-ZD31REeY.js","assets/w3m-modal-DH9uk_oe.js"])))=>i.map(i=>d[i]);
import { _ as Ut, __tla as __tla_0 } from "./pdf-utils-CLgdGVwQ.js";
import { f as Yn, e as At, G as As, U as Ns, a as Nn, h as Nt, b as bs, t as bn, N as Is, __tla as __tla_1 } from "./web3-vendor-CO8wHL-u.js";
    ...
    async function Un() {
        if (!Jt) {
            const { createPublicClient: e, http: t, defineChain: n } = await Ut(async ()=>{
                const { createPublicClient: s, http: r, defineChain: a } = await import("./web3-vendor-CO8wHL-u.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.c);
                return {
...
`;
        ...
        async initialize(t) {
            if (this.initializeProjectSettings(t), this.initControllers(t), await this.initChainAdapters(), this.sendInitializeEvent(t), t.features?.headless && !te.hasInjectedConnectors() && A.prefetch({
                ...
                const { ReownAuthentication: n } = await Ut(async ()=>{
                    const { ReownAuthentication: r } = await import("./features-Dg52djqm.js");
                    return {
    ...
    class ws extends Sa {
        ...
        async injectModalUi() {
            if (!Gn && E.isClient()) {
                if (await Ut(()=>import("./basic-Cnmx4mU2.js"), __vite__mapDeps([7,8,1,2,9,3,4,5,0])), await Ut(()=>import("./w3m-modal-DH9uk_oe.js"), __vite__mapDeps([10,8,1,2,0,3,4,5])), !document.querySelector("w3m-modal")) {
