...
import { p as K, v as ce, b as re, __tla as __tla_1 } from "./vaultService-XIwiRgwN.js";
import { l as D, d as ge, e as ye, __tla as __tla_2 } from "./index-O7MHFWtG.js";
        ...
        async exportData (s, i, t, e = "generic") {
            ...
            if (i === "generic_json") {
                const a = s.map((o)=>({
                        ...
                        digits: o.digits || 6,
                        period: o.period || 30,
                        algorithm: o.algorithm === "STEAM" ? "SHA1" : (o.algorithm || "SHA1").toUpperCase().replace("SHA-", "SHA")
                    }));
                return JSON.stringify({
                    version: "1.0",
...
`;
        ...
        async exportAsGaMigration (s) {
            ...
            const e = Math.floor(Math.random() * 2147483647), u = await ae(()=>import("./qr-utils-ZD31REeY.js").then((h)=>h.b), __vite__mapDeps([0,1,2,3])), n = [];
            function a(h, m) {
        ...
        async exportAsHtml (s) {
            const i = await ae(()=>import("./qr-utils-ZD31REeY.js").then((e)=>e.b), __vite__mapDeps([0,1,2,3])), t = [];
            t.push(`
      <!DOCTYPE html>
      <html>
      <head>
